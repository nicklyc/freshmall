...
public interface AdminRecommendService {
    ...
    @HttpMethod(description = "创建", permission = "admin:recommend:addRecommend", permissionParentName = "推广管理", permissionName = "推荐管理")
    ...
    @HttpMethod(description = "批量创建", permission = "admin:recommend:addRecommendBatch", permissionParentName = "推广管理", permissionName = "推荐管理")
    ...
    @HttpMethod(description = "删除", permission = "admin:recommend:deleteRecommend", permissionParentName = "推广管理", permissionName = "推荐管理")
    public Boolean deleteRecommend(
            @NotNull @HttpParam(name = "adminId", type = HttpParamType.ADMIN_ID, description = "管理员ID") Long adminId,
            @NotNull @HttpParam(name = "id", type = HttpParamType.COMMON, description = "推荐id") Long id,
            @NotNull @HttpParam(name = "recommendType", type = HttpParamType.COMMON, description = "推荐类型") Integer recommendType) throws ServiceException;

    @HttpMethod(description = "查询", permission = "admin:recommend:queryRecommendByType", permissionParentName = "推广管理", permissionName = "推荐管理")
    ...
    @HttpMethod(description = "查询", permission = "admin:recommend:queryAllRecommend", permissionParentName = "推广管理", permissionName = "推荐管理")
