...
public interface GoodsOutStockService {
    @HttpMethod(description = "列表", permission = "admin:goodsOutStock:list", permissionParentName = "前置仓管理", permissionName = "商品出库")
    ...
    @HttpMethod(description = "详情", permission = "admin:goodsOutStock:selectById", permissionParentName = "前置仓管理", permissionName = "商品出库")
    ...
    @HttpMethod(description = "添加", permission = "admin:goodsOutStock:create", permissionParentName = "前置仓管理", permissionName = "商品出库")
    ...
    @HttpMethod(description = "更新", permission = "admin:goodsOutStock:update", permissionParentName = "前置仓管理", permissionName = "商品出库")
    ...
    @HttpMethod(description = "出库", permission = "admin:goodsOutStock:updateOutOfStock", permissionParentName = "前置仓管理", permissionName = "商品出库")
    ...
    @HttpMethod(description = "删除出库信息", permission = "admin:goodsoutStock:delete", permissionParentName = "前置仓管理", permissionName = "商品出库")
    public String delete(
            @NotNull @HttpParam(name = "adminId", type = HttpParamType.ADMIN_ID, description = "管理员ID") Long adminId,
            @NotNull @HttpParam(name = "id", type = HttpParamType.COMMON, description = "出库主键id") Long id,
            @NotNull @HttpParam(name = "outStockNumbers", type = HttpParamType.COMMON, description = "出库单号") String outStockNumbers) throws ServiceException;

    @HttpMethod(description = "获取所有仓库的名称", permission = "admin:goodsOutStock:storagAllName", permissionParentName = "前置仓管理", permissionName = "商品出库")
