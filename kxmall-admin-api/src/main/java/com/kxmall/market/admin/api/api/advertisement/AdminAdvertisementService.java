...
public interface AdminAdvertisementService {
    ...
    @HttpMethod(description = "创建", permission = "promote:advertisement:addAdvertisement", permissionParentName = "轮播管理", permissionName = "广告管理")
    ...
    @HttpMethod(description = "删除", permission = "promote:advertisement:deleteAdvertisement", permissionParentName = "轮播管理", permissionName = "广告管理")
    ...
    @HttpMethod(description = "修改", permission = "promote:advertisement:updateAdvertisement", permissionParentName = "轮播管理", permissionName = "广告管理")
    ...
    @HttpMethod(description = "查询", permission = "promote:advertisement:queryAdvertisement", permissionParentName = "轮播管理", permissionName = "广告管理")
    ...
    @HttpMethod(description = "查询", permission = "promote:advertisement:queryAllAdvertisement", permissionParentName = "轮播管理", permissionName = "广告管理")
