	...
	<view>
		<view class="state">
			...
			<view class="state-time">
				...
				<!-- {{state == 3 || state == 4?'订单已完成':''}} -->
				{{state == 3 || state == 4 || state == 5 || state ==8? timeFormat(orderDetail.gmtUpdate) :''}}
			</view>
		...
		<view class="goods">
			...
			<view class="goods-one" v-for="(item, index) in orderDetail.skuList" :key="index">
			...
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">{{orderDetail.freightPrice/100}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp" style="color: #333333;">合计</text>
				<text class="cell-tip">￥{{orderDetail.skuTotalPrice/100}}</text>
			</view>
		</view>
		...
		<view class="yt-list">
			...
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip">{{orderDetail.city}} {{orderDetail.county}} {{orderDetail.address}}</text>
			</view>
			<view class="yt-list-cell b-b">
				<text class="cell-tit clamp">联系人 </text>
				<text class="cell-tip ">{{orderDetail.consignee}}</text>
			</view>
			<view class="yt-list-cell b-b">
		...
		<view class="yt-list">
			...
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip ">{{orderDetail.mono}}</text>
			</view>
			<view class="yt-list-cell b-b">
			...
			<view class="yt-list-cell b-b">
				...
				<text class="cell-tip ">{{timeFormat(orderDetail.gmtCreate)}}</text>
			</view>
			<view v-if="orderDetail.gmtPay"  class="yt-list-cell b-b">
				<text class="cell-tit clamp">支付时间 </text>
				<text class="cell-tip ">{{timeFormat(orderDetail.gmtPay)}}</text>
			</view>
...
<script>
	export default {
		...
		methods: {
			...
			countDown(){
				let date=this.orderDetail.gmtCreate //现在的时间戳
