  ...
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-input
        ...
        placeholder="请输入团购ID"
      />
      <el-select v-model="listQuery.status" style="width: 200px" filterable clearable class="filter-item" placeholder="请选择团购状态" >
        <el-option v-for="(item,index) in GroupShopStatusMap" :key="index" :label="item.name" :value="item.value" />
      </el-select>
      <el-button v-permission="['operation:groupShop:queryGroupShop']" class="filter-item" type="primary" icon="el-icon-search" @click="handleFilter">查找</el-button>
      <el-button v-permission="['operation:groupShop:addGroupShopSpu']" class="filter-item" type="primary" icon="el-icon-edit" @click="openSpuCreateDialog">添加</el-button>
    </div>
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['operation:groupShop:editGroupShopSpu']" v-show="scope.row.status === 0" type="primary" size="mini" @click="openSpuUpdateDialog(scope.row)">编辑</el-button>
          <el-button v-permission="['operation:groupShop:deleteGroupShopSpu']" v-show="scope.row.status === 0" type="danger" size="mini" @click="handleDelete(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
      ...
      <el-card class="box-card">
        ...
        >
          ...
          <el-form-item label="团购基础人数" >
            <el-input-number v-model="dataForm.minimumNumber" :precision="0" clearable controls-position="right" />
          </el-form-item>
      ...
      <el-dialog :visible.sync="groupShopUpdateSkuPriceDialog" :modal="true" :append-to-body="true" :close-on-click-modal = "false" top="10vh" width="70%" title="更新团购价格">
        ...
        >
          <el-form-item label="团购价格" >
            <el-input-number v-model="skuForm.skuGroupShopPrice" :precision="2" clearable controls-position="right" />元
          </el-form-item>
