    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="用户昵称" prop="nickname">
          <el-input v-model="dataForm.nickname" clearable />
        </el-form-item>
        <el-form-item label="用户手机号" prop="phone">
          <el-input v-model="dataForm.phone" clearable />
        </el-form-item>
        <el-form-item label="用户密码" prop="password">
          <el-input v-model="dataForm.password" clearable />
        </el-form-item>
        <el-form-item label="用户性别" prop="gender">
          <el-select v-model="dataForm.gender" placeholder="请选择" clearable filterable>
            <el-option v-for="(key, index) in genderDic" :key="index" :label="key.name" :value="key.value" />
          </el-select>
        </el-form-item>
        <el-form-item label="用户等级" prop="level">
          <el-select v-model="dataForm.level" placeholder="请选择" clearable filterable>
            <el-option v-for="(key, index) in levelDic" :key="index" :label="key.name" :value="key.value" />
          </el-select>
        </el-form-item>
