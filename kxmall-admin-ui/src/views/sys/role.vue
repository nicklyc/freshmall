<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="操作" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          ...
          <el-button v-permission="['admin:permission:datalist']" style="width:78px" type="primary" size="mini" @click="handleDataList(scope.row)" >数据授权</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <el-form-item label="说明" prop="desc">
          <el-input v-model="dataForm.desc" clearable />
        </el-form-item>
      </el-form>
    ...
    <el-dialog v-if="dataListVisible" :visible.sync="dataListVisible" title="数据权限">
      <data-list :dialog-role-id="dialogRoleId" @closeDialog="closeDialog"></data-list>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      dataListVisible: false, // 是否显示数据授权弹出层
      dialogRoleId: '' // 传给数据授权组件的角色id
    }
  },
  created() {
    this.getList()
