    ...
    <el-dialog :visible.sync="shipDialogVisible" title="发货">
      ...
      >
        <el-form-item label="快递公司" prop="shipCode">
          <el-select v-model="shipForm.shipCode" placeholder="请选择快递公司" clearable filterable>
            <el-option v-for="(key, value) in shipCodeMap" :key="key" :label="key" :value="value"/>
          </el-select>
        </el-form-item>
        <el-form-item label="快递编号" prop="shipNo">
          <el-input :disabled="shipForm.shipCode === 'NONE'" v-model="shipForm.shipNo" clearable />
        </el-form-item>
      </el-form>
